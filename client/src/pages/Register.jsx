  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-2">
        ...
        <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Create your CivicConnect Account</h2>
        <p className="text-xs text-slate-500">Join thousands of citizens making cities smarter</p>
      </div>
